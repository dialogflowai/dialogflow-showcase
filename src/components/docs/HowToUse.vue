    ...
    <el-timeline-item timestamp="#1 Prerequisite" placement="top">
      <el-card>
        ...
        <div class="description">
          ...
          <ul>
            <li>Frontend: <a
                href="https://github.com/dialogflowai/dialogflow/tree/main/frontend">https://github.com/dialogflowai/dialogflow/tree/main/frontend</a>
            </li>
            <li>Backend: <a
                href="https://github.com/dialogflowai/dialogflow">https://github.com/dialogflowai/dialogflow</a>
            </li>
          </ul>
        </div>
      </el-card>
